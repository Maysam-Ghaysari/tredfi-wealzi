const DiscountSection = () => {
  return (
    <section className="py-16 sm:py-20 max-w-[1100px] mx-auto px-4 sm:px-6  rounded-xl shadow-[0_-78px_90px_0px_rgba(0,0,0,2.5)]  ">
      <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-8 sm:gap-12 lg:gap-16">
